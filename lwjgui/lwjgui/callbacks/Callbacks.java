...
public final class Callbacks {
	...
	public static class DropCallback extends Callback<GLFWDropCallbackI> implements GLFWDropCallbackI {
		@Override
		public void invoke(long window, int xoffset, long yoffset) {
			for (GLFWDropCallbackI callback : callbacks)
				callback.invoke(window, xoffset, yoffset);
		}
	}
