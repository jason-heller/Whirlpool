...
public abstract class Node implements Resizable {
	...
	protected EventHandler<MouseEvent> mouseMovedEventInternal;
	...
	protected void onMouseMoved(double mouseX, double mouseY) {
		if (mouseMovedEventInternal != null) {
			EventHelper.fireEvent(mouseMovedEventInternal, new MouseEvent(mouseY, mouseY, -1));
		}
		
		if (mouseMovedEvent != null) {
			EventHelper.fireEvent(mouseMovedEvent, new MouseEvent(mouseY, mouseY, -1));
		}
	}
	...
	public EventHandler<MouseEvent> getMouseMovedEvent() {
	...
	protected EventHandler<MouseEvent> getMouseMovedEventInternal() {
		return mouseMovedEventInternal;
	}

	protected void setOnMouseMovedInternal(EventHandler<MouseEvent> mouseEnteredEventInternal) {
		this.mouseMovedEventInternal = mouseEnteredEventInternal;
	}
